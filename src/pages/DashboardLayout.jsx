...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex min-h-screen">
      <aside className="fixed inset-y-0 left-0 z-30 w-64 bg-slate-900 text-slate-300">
        ...
        <nav className="flex flex-col gap-1 p-3">
          ...
          {isPromoter && (
            <>
              ...
              <SidebarLink to="/app/registrations" label="Registrations" icon={icons.registrations} />
            </>
          )}
          ...
          {isClub && (
            <>
              ...
              <SidebarLink to="/app/club/register" label="Register Boxers" icon={icons.registrations} />
          ...
          {isOfficial && (
            <>
              <SidebarLink to="/app/events" label="Events" icon={icons.events} />
              <SidebarLink to="/app/registrations" label="Records" icon={icons.registrations} />
            </>
          )}
        </nav>
